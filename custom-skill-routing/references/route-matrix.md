...
Use this quick owner map when `custom-skill-routing` needs a fast routing decision.

- Product direction is still ambiguous:
...
- Figma is the active design source:
  `figma`
- Google Stitch is the active design source:
  `google-stitch`
