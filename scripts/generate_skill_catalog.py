...
def main() -> int:
    ...
    manifest_payload = {
        ...
        "default_routing_check_command": "python3 ~/.agents/skills/scripts/check_skill_routing.py",
        "default_export_command": "python3 ~/.agents/skills/scripts/export_universal_skills.py ~/skills/exports --flatten",
        "profiles": [
            "universal-folder",
            "flattened-markdown",
            "codex-local",
